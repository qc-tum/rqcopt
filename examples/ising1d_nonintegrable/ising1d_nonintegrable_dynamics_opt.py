...
def ising1d_dynamics_opt(nlayers: int, bootstrap: bool, coeffs_start=[], **kwargs):
    ...
    if bootstrap:
        ...
        with h5py.File(f"ising1d_nonintegrable_dynamics_opt_n{nlayers-2}.hdf5", "r") as f:
    ...
    with h5py.File(f"ising1d_nonintegrable_dynamics_opt_n{nlayers}.hdf5", "w") as f:
...
def main():
    ...
    # 9 layers
    ising1d_dynamics_opt(9, True, niter=1000, tcg_abstol=1e-12, tcg_reltol=1e-10)
